// Object.create(prototype)  -> 创建一个新对象，传入的参数作为新对象的原型
// Object.getPrototypeOf(object)  -> 获得传入的对象的原型
// Object.setPrototypeOf(object,prototype) -> 设置传入的object对象的原型为传入的prototype
